        ...
        <div className='w-full md:min-w-[450px] flex flex-col'>
            {!selectedConversation ? <NoChatSelected /> : <>
                <div className='bg-slate-500 px-4 py-2 mb-2'>
                    <span className='label-text text-[10px] sm:text-[16px] text-white'>To:</span>{" "}
                    <span className='text-white text-[10px] sm:text-[16px]'>{selectedConversation.fullName}</span>
                </div>
                <Messages />
                <MessageInput />
            </>}
